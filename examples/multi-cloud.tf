...
module "scaleway_image" {
  source   = "github.com/miran248/terraform-talos-modules//modules/scaleway-image?ref=v4.2.7" # x-release-please-version
...
module "paris_pool" {
  source = "github.com/miran248/terraform-talos-modules//modules/scaleway-pool?ref=v4.2.7" # x-release-please-version
...
module "nuremberg_pool" {
  source = "github.com/miran248/terraform-talos-modules//modules/hcloud-pool?ref=v4.2.7" # x-release-please-version
...
module "paris_apply" {
  source = "github.com/miran248/terraform-talos-modules//modules/scaleway-apply?ref=v4.2.7" # x-release-please-version
...
module "nuremberg_apply" {
  source = "github.com/miran248/terraform-talos-modules//modules/hcloud-apply?ref=v4.2.7" # x-release-please-version
