...
- Keep its KubeSpan interface and PodCIDR route MTUs at the 1420-byte WireGuard ceiling while `cilium-ipv6-direct` independently limits pod traffic to 1400, below the measured 1410-byte netkit/BPF FIB boundary.
