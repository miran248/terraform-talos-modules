...
module "nuremberg_pool" {
  source = "github.com/miran248/terraform-talos-modules//modules/hcloud-pool?ref=v2.0.0"
...
module "talos_cluster" {
  source = "github.com/miran248/terraform-talos-modules//modules/talos-cluster?ref=v2.0.0"
...
module "hcloud_apply" {
  ...
  source = "github.com/miran248/terraform-talos-modules//modules/hcloud-apply?ref=v2.0.0"
...
module "talos_apply" {
  source = "github.com/miran248/terraform-talos-modules//modules/talos-apply?ref=v2.0.0"
